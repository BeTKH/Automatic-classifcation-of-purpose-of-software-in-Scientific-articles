    ...
    for line in lines:
        ...
        if line.rstrip():
            ...
            if line.startswith('T'):
                ...
                # annotation label e.g Usage:Purpose

                ann_label = line_split[1]
                    
                # annotation beginning number
                ann_beg   = line_split[2]
                
                # annotation ending number
                ann_end   = line_split[3]
                
                # software name 
                swName    = line_split[4].rstrip()
