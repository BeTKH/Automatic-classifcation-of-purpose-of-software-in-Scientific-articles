...
\begin{figure}[h]
	...
	\caption[Subfloat - Figure]{The result of network analysis from Gephi software - indicates the relation between each software category. The Degree filter with a range of 1 to 60 indicates prominence of a node in the network. Large value correspondences to a parent node (more general software category).}
...
Sample list of domain specific key-words that would potentially indicate a software usage purpose is listed in the table 3.5. 
